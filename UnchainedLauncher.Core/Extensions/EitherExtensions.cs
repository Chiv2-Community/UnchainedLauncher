...
namespace UnchainedLauncher.Core.Extensions {
    public static class UnchainedEitherExtensions {
        ...
        public static Either<L, R> Tap<L, R>(this Either<L, R> either, Action<R> f) {
            return either.Map(r => {
                f(r);
                return r;
            });
        ...
        public static Either<L, R> TapRight<L, R, R2>(this Either<L, R> either, Action<R> f) {
            return Tap(either, f);
        }
        ...
        public static Either<L, R> TapLeft<L, R, L2>(this Either<L, R> either, Action<L> f) {
        ...
        public static Either<L, R> BindTap<L, R, R2>(this Either<L, R> either, Func<R, Either<L, R2>> f) {
        ...
        public static Either<L, R> BindTapRight<L, R, R2>(this Either<L, R> either, Func<R, Either<L, R2>> f) {
        ...
        public static Either<L, R> BindTapLeft<L, R, L2>(this Either<L, R> either, Func<L, Either<L2, R>> f) {
