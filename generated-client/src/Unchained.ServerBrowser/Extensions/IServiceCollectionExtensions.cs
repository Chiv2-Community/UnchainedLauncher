...
namespace Unchained.ServerBrowser.Extensions
{
    ...
    public static class IServiceCollectionExtensions
    {
        ...
        public static void AddServerBrowserAPI(this IServiceCollection services)
        {
            HostConfiguration config = new(services);
            AddServerBrowserAPI(services, config);
        }
        ...
        public static void AddServerBrowserAPI(this IServiceCollection services, Action<HostConfiguration> options)
        {
            HostConfiguration config = new(services);
            options(config);
            AddServerBrowserAPI(services, config);
        ...
        internal static void AddServerBrowserAPI(IServiceCollection services, HostConfiguration host)
        {
            if (!host.HttpClientsAdded)
                host.AddServerBrowserAPIHttpClients();
