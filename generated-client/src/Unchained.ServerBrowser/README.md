...
inputSpec: https://raw.githubusercontent.com/Chiv2-Community/C2ServerBrowserBackend/refs/heads/main/assets/chiv2-server-browser-api.yaml
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{5543AD48-03D7-4B5C-93FE-0601D197CBFA}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IApiPlayfabClientMatchmakePostApiResponse apiResponse = await api.ApiPlayfabClientMatchmakePostAsync("todo");
            PlayfabMatchmakeResponse? model = apiResponse.Ok();
        }

        public static IHostBuilder CreateHostBuilder(string[] args) => Host.CreateDefaultBuilder(args)
          .ConfigureServerBrowserAPI((context, services, options) =>
          {
              ...
              options.AddServerBrowserAPIHttpClients(client =>
              {
